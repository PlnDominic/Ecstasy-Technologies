...
const Navigation: React.FC = () => {
  ...
  return (
    <nav className="bg-white border-r border-gray-200 w-64 min-h-screen">
      ...
      <div className="mt-5 flex flex-col px-3 space-y-1">
        {navigation.map((item) => (
          <Link
            key={item.name}
            href={item.href}
            className="flex items-center px-3 py-3 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-100 hover:text-gray-900"
          >
